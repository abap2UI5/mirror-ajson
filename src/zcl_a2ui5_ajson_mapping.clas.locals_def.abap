CLASS lcl_mapping_fields DEFINITION.
  ...
  PRIVATE SECTION.
    DATA mt_mapping_fields TYPE zif_a2ui5_ajson_mapping~ty_mapping_fields.
...
CLASS lcl_rename DEFINITION.
  ...
  PRIVATE SECTION.
    DATA mt_rename_map TYPE zif_a2ui5_ajson_mapping~tty_rename_map.
...
CLASS lcl_mapping_to_upper DEFINITION.
  ...
  PRIVATE SECTION.
    DATA mi_mapping_fields TYPE REF TO zif_a2ui5_ajson_mapping.
...
CLASS lcl_compound_mapper DEFINITION.
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        it_queue TYPE zif_a2ui5_ajson_mapping=>ty_table_of.

  PROTECTED SECTION.

  PRIVATE SECTION.
    DATA mt_queue TYPE zif_a2ui5_ajson_mapping=>ty_table_of.
