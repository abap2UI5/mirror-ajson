CLASS zcl_a2ui5_ajson DEFINITION
  PUBLIC
  CREATE PUBLIC .

  PUBLIC SECTION.

    INTERFACES zif_a2ui5_ajson .

    ALIASES:
      is_empty FOR zif_a2ui5_ajson~is_empty,
      exists FOR zif_a2ui5_ajson~exists,
      members FOR zif_a2ui5_ajson~members,
      get FOR zif_a2ui5_ajson~get,
      get_boolean FOR zif_a2ui5_ajson~get_boolean,
      get_integer FOR zif_a2ui5_ajson~get_integer,
      get_number FOR zif_a2ui5_ajson~get_number,
      get_date FOR zif_a2ui5_ajson~get_date,
      get_timestamp FOR zif_a2ui5_ajson~get_timestamp,
      get_string FOR zif_a2ui5_ajson~get_string,
      slice FOR zif_a2ui5_ajson~slice,
      to_abap FOR zif_a2ui5_ajson~to_abap,
      array_to_string_table FOR zif_a2ui5_ajson~array_to_string_table.

    ALIASES:
      clear FOR zif_a2ui5_ajson~clear,
      set FOR zif_a2ui5_ajson~set,
      setx FOR zif_a2ui5_ajson~setx,
      set_boolean FOR zif_a2ui5_ajson~set_boolean,
      set_string FOR zif_a2ui5_ajson~set_string,
      set_integer FOR zif_a2ui5_ajson~set_integer,
      set_date FOR zif_a2ui5_ajson~set_date,
      set_timestamp FOR zif_a2ui5_ajson~set_timestamp,
      set_null FOR zif_a2ui5_ajson~set_null,
      delete FOR zif_a2ui5_ajson~delete,
      touch_array FOR zif_a2ui5_ajson~touch_array,
      push FOR zif_a2ui5_ajson~push,
      stringify FOR zif_a2ui5_ajson~stringify.

    ALIASES:
      clone FOR zif_a2ui5_ajson~clone,
      filter FOR zif_a2ui5_ajson~filter,
      map FOR zif_a2ui5_ajson~map.

    ALIASES:
      mt_json_tree FOR zif_a2ui5_ajson~mt_json_tree,
      keep_item_order FOR zif_a2ui5_ajson~keep_item_order,
      format_datetime FOR zif_a2ui5_ajson~format_datetime,
      to_abap_corresponding_only FOR zif_a2ui5_ajson~to_abap_corresponding_only,
      freeze FOR zif_a2ui5_ajson~freeze.

    CLASS-METHODS parse
      IMPORTING
        !iv_json            TYPE string
        !iv_freeze          TYPE abap_bool DEFAULT abap_false
        !ii_custom_mapping  TYPE REF TO zif_a2ui5_ajson_mapping OPTIONAL
        !iv_keep_item_order TYPE abap_bool DEFAULT abap_false
      RETURNING
        VALUE(ro_instance) TYPE REF TO zcl_a2ui5_ajson
      RAISING
    ...
    CLASS-METHODS create_from " TODO, rename to 'from' ?
      IMPORTING
        !ii_source_json TYPE REF TO zif_a2ui5_ajson
        !ii_filter TYPE REF TO zif_a2ui5_ajson_filter OPTIONAL " Might be deprecated, use filter() instead
        !ii_mapper TYPE REF TO zif_a2ui5_ajson_mapping OPTIONAL " Might be deprecated, use map() instead
      RETURNING
        VALUE(ro_instance) TYPE REF TO zcl_a2ui5_ajson
      RAISING
        zcx_a2ui5_ajson_error .
  ...
  PRIVATE SECTION.
    ...
    DATA ms_opts TYPE zif_a2ui5_ajson=>ty_opts.
    DATA mi_custom_mapping TYPE REF TO zif_a2ui5_ajson_mapping. " DEPRECATED, will be removed

    METHODS get_item
      IMPORTING
        iv_path        TYPE string
      RETURNING
        VALUE(rv_item) TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
    METHODS prove_path_exists
      IMPORTING
        iv_path              TYPE string
      RETURNING
        VALUE(rr_end_node) TYPE REF TO zif_a2ui5_ajson_types=>ty_node
      RAISING
        zcx_a2ui5_ajson_error.
    METHODS delete_subtree
      IMPORTING
        iv_path           TYPE string
        iv_name           TYPE string
        ir_parent         TYPE REF TO zif_a2ui5_ajson_types=>ty_node OPTIONAL
      RETURNING
        VALUE(rs_top_node) TYPE zif_a2ui5_ajson_types=>ty_node.
...
CLASS zcl_a2ui5_ajson IMPLEMENTATION.
  ...
  METHOD create_from.
    ...
    IF ii_source_json IS NOT BOUND.
      zcx_a2ui5_ajson_error=>raise( 'Source not bound' ).
    ENDIF.
  ...
  METHOD get_item.
    ...
    DATA ls_path_name TYPE zif_a2ui5_ajson_types=>ty_path_name.
    ...
    DO.
      ...
      IF sy-subrc <> 0. " New node, assume it is always object as it has a named child, use touch_array to init array
        ...
        IF lr_node_parent IS NOT INITIAL. " if has parent
          ...
          IF lr_node_parent->type = zif_a2ui5_ajson_types=>node_type-array.
        ...
        ls_new_node-type = zif_a2ui5_ajson_types=>node_type-object.
  ...
  METHOD read_only_watchdog.
    IF ms_opts-read_only = abap_true.
      zcx_a2ui5_ajson_error=>raise( 'This json instance is read only' ).
    ENDIF.
  ENDMETHOD.


  METHOD zif_a2ui5_ajson~array_to_string_table.

    DATA lv_normalized_path TYPE string.
    DATA lr_node TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
    FIELD-SYMBOLS <item> LIKE LINE OF mt_json_tree.
    ...
    IF lr_node IS INITIAL.
      zcx_a2ui5_ajson_error=>raise( |Path not found: { iv_path }| ).
    ENDIF.
    IF lr_node->type <> zif_a2ui5_ajson_types=>node_type-array.
      zcx_a2ui5_ajson_error=>raise( |Array expected at: { iv_path }| ).
    ENDIF.

    LOOP AT mt_json_tree ASSIGNING <item> WHERE path = lv_normalized_path.
      CASE <item>-type.
        WHEN zif_a2ui5_ajson_types=>node_type-number OR zif_a2ui5_ajson_types=>node_type-string.
          APPEND <item>-value TO rt_string_table.
        WHEN zif_a2ui5_ajson_types=>node_type-null.
          APPEND '' TO rt_string_table.
        WHEN zif_a2ui5_ajson_types=>node_type-boolean.
        ...
        WHEN OTHERS.
          zcx_a2ui5_ajson_error=>raise( |Cannot convert [{ <item>-type
  ...
  METHOD zif_a2ui5_ajson~clone.
    ri_json = create_from( me ).
  ENDMETHOD.


  METHOD zif_a2ui5_ajson~delete.

    read_only_watchdog( ).

    DATA ls_split_path TYPE zif_a2ui5_ajson_types=>ty_path_name.
  ...
  METHOD zif_a2ui5_ajson~exists.
    rv_exists = boolc( get_item( iv_path ) IS NOT INITIAL ).
  ENDMETHOD.


  METHOD zif_a2ui5_ajson~filter.
    ri_json = create_from(
      ii_source_json = me
      ii_filter      = ii_filter ).
  ENDMETHOD.
  ...
  METHOD zif_a2ui5_ajson~format_datetime.
    ms_opts-format_datetime = iv_use_iso.
    ri_json = me.
  ENDMETHOD.


  METHOD zif_a2ui5_ajson~freeze.
    ms_opts-read_only = abap_true.
  ENDMETHOD.


  METHOD zif_a2ui5_ajson~get.

    DATA lr_item TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
  ...
  METHOD zif_a2ui5_ajson~get_boolean.

    DATA lr_item TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS INITIAL OR lr_item->type = zif_a2ui5_ajson_types=>node_type-null.
      RETURN.
    ELSEIF lr_item->type = zif_a2ui5_ajson_types=>node_type-boolean.
  ...
  METHOD zif_a2ui5_ajson~get_date.
    ...
    IF lr_item IS NOT INITIAL AND lr_item->type = zif_a2ui5_ajson_types=>node_type-string.
  ...
  METHOD zif_a2ui5_ajson~get_integer.

    DATA lr_item TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS NOT INITIAL AND lr_item->type = zif_a2ui5_ajson_types=>node_type-number.
      rv_value = lr_item->value.
    ENDIF.
  ...
  METHOD zif_a2ui5_ajson~get_node_type.
  ...
  METHOD zif_a2ui5_ajson~get_number.
  ...
  METHOD zif_a2ui5_ajson~get_string.

    DATA lr_item TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    IF lr_item IS NOT INITIAL AND lr_item->type <> zif_a2ui5_ajson_types=>node_type-null.
      rv_value = lr_item->value.
    ENDIF.
  ...
  METHOD zif_a2ui5_ajson~get_timestamp.
  ...
  METHOD zif_a2ui5_ajson~is_empty.
    rv_yes = boolc( lines( mt_json_tree ) = 0 ).
  ENDMETHOD.


  METHOD zif_a2ui5_ajson~keep_item_order.
    ms_opts-keep_item_order = abap_true.
    ri_json = me.
  ENDMETHOD.


  METHOD zif_a2ui5_ajson~map.
    ri_json = create_from(
      ii_source_json = me
      ii_mapper      = ii_mapper ).
  ENDMETHOD.
  ...
  METHOD zif_a2ui5_ajson~members.
  ...
  METHOD zif_a2ui5_ajson~opts.
    rs_opts = ms_opts.
  ENDMETHOD.


  METHOD zif_a2ui5_ajson~push.

    DATA lr_parent TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
    DATA lr_new_node TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
    ...
    IF lr_parent IS INITIAL.
      zcx_a2ui5_ajson_error=>raise( |Path [{ iv_path }] does not exist| ).
    ENDIF.

    IF lr_parent->type <> zif_a2ui5_ajson_types=>node_type-array.
      zcx_a2ui5_ajson_error=>raise( |Path [{ iv_path }] is not array| ).
    ENDIF.

    DATA lt_new_nodes TYPE zif_a2ui5_ajson_types=>ty_nodes_tt.
    DATA ls_new_path TYPE zif_a2ui5_ajson_types=>ty_path_name.
  ...
  METHOD zif_a2ui5_ajson~set.

    DATA ls_split_path TYPE zif_a2ui5_ajson_types=>ty_path_name.
    DATA lr_parent TYPE REF TO zif_a2ui5_ajson_types=>ty_node.
    DATA ls_deleted_node TYPE zif_a2ui5_ajson_types=>ty_node.
    DATA lv_item_order TYPE zif_a2ui5_ajson_types=>ty_node-order.
    ...
    IF iv_node_type IS NOT INITIAL
      AND iv_node_type <> zif_a2ui5_ajson_types=>node_type-boolean AND iv_node_type <> zif_a2ui5_ajson_types=>node_type-null
      AND iv_node_type <> zif_a2ui5_ajson_types=>node_type-number AND iv_node_type <> zif_a2ui5_ajson_types=>node_type-string.
      zcx_a2ui5_ajson_error=>raise( |Unexpected type { iv_node_type }| ).
    ENDIF.
    ...
    ELSEIF lr_parent->type = zif_a2ui5_ajson_types=>node_type-object
  ...
  METHOD zif_a2ui5_ajson~setx.
    ...
    IF lv_val = 'null'.
      zif_a2ui5_ajson~set_null( lv_path ).
    ELSEIF lv_val = 'true'.
      zif_a2ui5_ajson~set_boolean(
        iv_path = lv_path
        iv_val  = abap_true ).
    ELSEIF lv_val = 'false'.
      zif_a2ui5_ajson~set_boolean(
  ...
  METHOD zif_a2ui5_ajson~set_boolean.
  ...
  METHOD zif_a2ui5_ajson~set_date.
  ...
  METHOD zif_a2ui5_ajson~set_integer.
  ...
  METHOD zif_a2ui5_ajson~set_null.
  ...
  METHOD zif_a2ui5_ajson~set_string.
  ...
  METHOD zif_a2ui5_ajson~set_timestamp.
  ...
  METHOD zif_a2ui5_ajson~slice.

    DATA lo_section         TYPE REF TO zcl_a2ui5_ajson.
    DATA ls_item            LIKE LINE OF mt_json_tree.
    DATA lv_normalized_path TYPE string.
    DATA ls_path_parts      TYPE zif_a2ui5_ajson_types=>ty_path_name.
  ...
  METHOD zif_a2ui5_ajson~stringify.
  ...
  METHOD zif_a2ui5_ajson~touch_array.
    ...
    IF ls_split_path IS INITIAL. " Assign root, exceptional processing
      ...
      ls_new_node-type = zif_a2ui5_ajson_types=>node_type-array.
    ...
    ELSEIF lr_node->type <> zif_a2ui5_ajson_types=>node_type-array.
      zcx_a2ui5_ajson_error=>raise( |Path [{ iv_path }] already used and is not array| ).
    ENDIF.
  ...
  METHOD zif_a2ui5_ajson~to_abap.
    ...
    lo_to_abap->to_abap(
      EXPORTING
        it_nodes    = zif_a2ui5_ajson~mt_json_tree
      CHANGING
  ...
  METHOD zif_a2ui5_ajson~to_abap_corresponding_only.
